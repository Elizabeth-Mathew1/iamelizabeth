    ...
    <div className="page-root">
      ...
      <div className="flex min-h-screen w-screen bg-[var(--color-bg)] relative">
        ...
        <div className="fixed top-0 w-full h-[15%] bg-[var(--color-bg)] flex items-center justify-between">
          <div className="text-[20px] md:text-[22px] text-[var(--color-accent)] mt-4 pl-4 md:pl-[80px] lg:pl-[180px] 2xl:pl-[650px]" style={{ fontFamily: 'var(--font-main)' }}>
            -BLOGS
          </div>
        ...
        {/* Scrollable content */}
        <div className="mt-30 xl:mt-30 2xl:mt-45 overflow-y-auto max-w-10xl mx-auto px-4 md:px-8">
          <div className="mb-20">
          ...
          {/* Blog entries list */}
          <div className="space-y-0 max-w-10xl px-2 md:px-0">
            {sortedEntries.map((blog, index) => (
              <div key={blog.slug}>
                <Link href={`/blogs/${blog.slug}`}>
                  <div className="blog-entry group py-4 rounded-lg cursor-pointer px-2 md:px-4">
                ...
                {index < sortedEntries.length - 1 && (
                  <div className="h-[1px] bg-gray-700 mx-2 md:mx-4"></div>
                )}
              </div>
            ))}
          </div>
